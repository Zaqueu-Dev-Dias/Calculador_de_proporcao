...
import 'Funcionalidade/cadastrar_peso/cadastrar_view.dart';
import 'Funcionalidade/cadastrar_peso/cadastrofinal.dart';
...
void main() {
  ...
  ],child: MaterialApp(home: ReceitaSelecionada(),),),
  );
}
